      ...
      <div className="relative z-10 container mx-auto px-4 text-center py-24">
        <div data-aos="fade-up">
          <h1 className="text-5xl md:text-7xl font-extrabold mb-6">
            <span className="bg-clip-text text-transparent bg-gradient-to-r from-addiona-maroon-light via-addiona-maroon to-addiona-gray-300">
              Addiona:
            </span>{" "}
        ...
        <div className="flex flex-col sm:flex-row justify-center items-center space-y-4 sm:space-y-0 sm:space-x-6" data-aos="fade-up" data-aos-delay="400">
          ...
          <Button
            size="lg"
            variant="outline"
            className="text-white border-addiona-gray-300 hover:bg-addiona-gray-300/10 hover:text-white px-10 py-6 text-lg font-semibold rounded-lg shadow-md hover:shadow-lg transform hover:scale-105 transition-all duration-300"
          >
            Watch Demo
          </Button>
        </div>
...
// Add these to tailwind.config.js if you want more control:
// keyframes: { ... 'spin-slow': 'spin 10s linear infinite', }
// animation: { ... 'spin-slow': 'spin-slow', }
