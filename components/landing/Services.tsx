...
const servicesData = [
  {
    icon: <Workflow className="h-12 w-12 text-[var(--color-addiona)] group-hover:scale-110 transition-transform" />,
  ...
  {
    icon: <Layers className="h-12 w-12 text-[var(--color-addiona)] group-hover:scale-110 transition-transform" />,
  ...
  {
    icon: <DatabaseZap className="h-12 w-12 text-[var(--color-addiona)] group-hover:scale-110 transition-transform" />,
  ...
  {
    icon: <Users className="h-12 w-12 text-[var(--color-addiona)] group-hover:scale-110 transition-transform" />,
   ...
   {
    icon: <ShoppingCart className="h-12 w-12 text-[var(--color-addiona)] group-hover:scale-110 transition-transform" />,
  ...
  {
    icon: <ShieldCheck className="h-12 w-12 text-[var(--color-addiona)] group-hover:scale-110 transition-transform" />,
          ...
          {servicesData.map((service, index) => (
            <div key={index} data-aos="fade-up" data-aos-delay={`${index * 100}`}>
              <Card className={`group h-full flex flex-col shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border-2 ${service.borderColor} ${service.bgColor} overflow-hidden`}>
                ...
                <div className="h-1 w-0 bg-[var(--color-addiona)] group-hover:w-full transition-all duration-500 ease-out mt-auto"></div>
              </Card>
            </div>
          ))}
        </div>
