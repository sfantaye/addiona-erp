      ...
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div data-aos="fade-right">
            <h2 className="text-sm font-semibold text-[var(--color-addiona)] tracking-widest uppercase mb-2">About Addiona</h2>
            <h3 className="text-4xl lg:text-5xl font-extrabold mb-6">
              Pioneering the <span className="text-[var(--color-addiona)]">Future</span> of Enterprise Solutions
            </h3>
            ...
            <div className="space-y-5 mb-8">
              <div className="flex items-start" data-aos="fade-up" data-aos-delay="100">
                <div className="flex-shrink-0 h-8 w-8 rounded-full bg-[var(--color-addiona)]/10 text-[var(--color-addiona)] flex items-center justify-center mr-4">
                  <Target size={20} />
                </div>
                <div>
            ...
            <a
              ...
              className="inline-block bg-[var(--color-addiona)] text-white font-semibold py-3 px-8 rounded-lg shadow-md hover:bg-[var(--color-addiona)]-dark hover:shadow-lg transition-all transform hover:scale-105"
            >
              Learn More About Us
            </a>
          </div>
          ...
          <div className="relative h-96 md:h-[500px] rounded-xl overflow-hidden shadow-2xl" data-aos="fade-left" data-aos-delay="200">
            ...
            <div className="absolute inset-0 bg-gradient-to-br from-[var(--color-addiona)] via-[var(--color-addiona)]-500 to-[var(--color-addiona)]-100/40  z-10"></div>
